"""toulousecommute URL Configuration
...
from toulousecommuter.api import (AgencyResource, CalendarResource, CalendarDateResource,
                                  FrequencyResource, RouteResource, ShapeResource, StopResource,
                                  StopTimeResource, TripResource)
